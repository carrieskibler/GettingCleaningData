...
# total_acc_x_test <- read.table("./data/UCI HAR dataset/test/Inertial Signals/body_acc_x_test.txt")
# total_acc_y_test <- read.table("./data/UCI HAR dataset/test/Inertial Signals/body_acc_y_test.txt")
# total_acc_z_test <- read.table("./data/UCI HAR dataset/test/Inertial Signals/body_acc_z_test.txt")
...
# total_acc_x_train <- read.table("./data/UCI HAR dataset/train/Inertial Signals/body_acc_x_train.txt")
# total_acc_y_train <- read.table("./data/UCI HAR dataset/train/Inertial Signals/body_acc_y_train.txt")
# total_acc_z_train <- read.table("./data/UCI HAR dataset/train/Inertial Signals/body_acc_z_train.txt")
